...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // clicking menu button dims and pauses the game and reveals hidden
  // div containing 4 buttons:
  // - About: reveals hidden div containing simple 'about'
  // - Instructions: reveals hidden div containing instructions
  // - Resume: hides div and resumes game
